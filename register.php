...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO auth (role,user_name,email,password) VALUES (?,?,?, ?)";
    $stmti = $conn->prepare($sql);
    $stmti->bind_param("ssss",$role,$user_name,$email,$password );
        ...
        <div class="bg-white shadow-md rounded-md p-6">
            ...
            <form class="space-y-6" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input name="user_name" type="user_name" required
